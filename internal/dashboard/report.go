...
<body>
            ...
            <div class="header-content">
                ...
                <div class="meta-info">
                    ...
                    <div class="meta-item">
                        ...
                        <div class="meta-value">{{.ExecutionSummary.ThroughputMsgSec | printf "%.1f"}} msgs/sec</div>
                    </div>
                </div>
            </div>
        </div>
                ...
                <table class="topic-table">
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td>{{.ProduceRate | printf "%.1f"}} msgs/sec</td>
                            <td>{{.ConsumeRate | printf "%.1f"}} msgs/sec</td>
                ...
                <div style="display: grid; grid-template-columns: 1fr 1fr; gap: 2rem;">
                    ...
                    <div>
                        ...
                        <div class="metrics-grid">
                            ...
                            <div class="metric-card">
                                ...
                                <div class="metric-value">{{.ProducerMetrics.MessagesPerSec | printf "%.1f"}} <span class="metric-unit">msgs/sec</span></div>
                            </div>
                            <div class="metric-card">
                                <div class="metric-label">Success Rate</div>
                    ...
                    <div>
                        ...
                        <div class="metrics-grid">
                            ...
                            <div class="metric-card">
                                <div class="metric-label">Throughput</div>
                                <div class="metric-value">{{.ConsumerMetrics.MessagesPerSec | printf "%.1f"}} <span class="metric-unit">msgs/sec</span></div>
                            </div>
                            <div class="metric-card">
    ...
    <div class="footer">
        <div class="container">
            Report generated by PipeGen v1.0 • {{.LastUpdated.Format "January 2, 2006 at 15:04:05"}}
        </div>
    </div>
</body>
</html>`
...
│                 │    │                 │    │                 │    │                 │
│ Rate: %s msgs/sec│    │ %s partitions   │    │ %d jobs active  │    │ %s messages     │
