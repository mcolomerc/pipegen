...
func NewProjectGeneratorWithLLM(projectName, projectPath string, localMode bool, content *LLMContent) *LLMProjectGenerator {
	base := NewProjectGenerator(projectName, projectPath, localMode)
